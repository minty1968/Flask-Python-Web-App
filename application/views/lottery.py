...
def lotto():
    ...
    return render_template('lottery/lotto.html',
                           ...
                           template='lottery-template main',
...
def euro():
    ...
    return render_template('lottery/euro.html',
...
def s4l():
    ...
    return render_template('lottery/s4l.html',
...
def thunder():
    ...
    return render_template('lottery/thunder.html',
